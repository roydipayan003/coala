...
You may ask for a review after you have done a review as well.
When you ask for it, please provide a link of something you just reviewed.
We need to do this so everyone gets timely reviews and people who are
helping with this get preferred.
Go to `our list of PRs that are awaiting reviews <http://coala.io/review>`_
and choose a PR that is labeled with `difficulty/newcomer`. These PRs are from
other newcomers and should require little understanding of the coala codebase
to help you learning the reviewing process. If there are no newcomer PRs
waiting for reviews you can still take a look at any of the listed PRs.
...
You can find information about how reviewing code works in our
...
It helps us maintain coala **clean** and **stable**.
...
If your commit message was considered fine by our reviewers, you can simply
send it again like this.
If not, edit it and send it.
You have successfully edited your last commit!

.. note::

    Every time you change your commits, also rebase, following
    `our guide <coala.io/rebase>`_.
